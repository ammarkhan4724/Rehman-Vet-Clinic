  ...
  return (
    <aside aria-label="WhatsApp quick contact" className="fixed bottom-6 right-6 z-50 flex items-center group">
      ...
      <a
        ...
        className="relative w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white grid place-items-center shadow-2xl shadow-[#25D366]/40 hover:scale-110 active:scale-95 transition-all duration-300 ring-4 ring-white/80 animate-wiggle-periodic animate-radar"
      >
        {/* WhatsApp Icon */}
        <svg width="32" height="32" viewBox="0 0 448 512" fill="currentColor" aria-hidden="true" className="drop-shadow-sm">
